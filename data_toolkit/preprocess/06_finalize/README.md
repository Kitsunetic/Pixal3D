...
04의 성공 asset 중 `stages.encode.exclude_asset_ids`와 05 manifest의 `skipped_oversized`에
해당하지 않는 asset마다 03 렌더 8장과 transform, 05의 shape/PBR/SS latent 및 scale JSON을 확인한다.
