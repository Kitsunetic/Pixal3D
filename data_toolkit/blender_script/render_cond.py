...
def main(arg):
    ...
    final_samples = bpy.context.scene.cycles.samples
...
if __name__ == '__main__':
    ...
    parser.add_argument('--boundary_fit_samples', type=int, default=1, help='Cycles samples used while fitting camera boundaries.')
